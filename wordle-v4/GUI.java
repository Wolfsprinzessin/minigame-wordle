...
public class GUI extends JFrame implements ActionListener {
    ...
    public static void EndWordle() {
        ...
        System.out.println("Wordle: Gelöst in " + ((System.currentTimeMillis() - startTime) / 1000) + " Sekunden und " + tries + " Versuchen.");
...
//just reset answer every time
    ...
    public static String ReturnRandomWord(){
        ...
        return possibleWords[(int)(Math.random() * (possibleWords.length - 1))]; //returns a random word from this large list
    }
}