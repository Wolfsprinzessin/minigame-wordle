...
public class Spiel extends SpielOberflaeche {
    ...
    public static void neustartSpiel() {
        System.out.println("Startet ein Neues Spiel");
    }
    ...
    public static void enterWord(){ //if its good, submit the word for checking
        ...
        if ( IsAValidWord(eingabewort.getText(), wortliste) ) {
            buttonPressed();
        } else {
            System.out.println("Wordle: Das Wort ist nicht in der Liste");
        }
    }
