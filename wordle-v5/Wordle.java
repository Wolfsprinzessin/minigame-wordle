...
public class Wordle extends JFrame implements ActionListener {
	...
	public static void main(String[] args) {
        ...
        labels = new JLabel[6];
        for (int i = 0; i < 6; i++) {
            labels[i] = new JLabel("<html><font size='7' color=blue> ----- </font> <font"); // das "Eingabefeld"
    ...
    public static void EndWordle() {
        ...
        if (!done) stats.setText("<html><font size='5' color=red> " + "Die Antwort war: " + new String(answerWord) + ".</font> <font");
        else  stats.setText("<html><font size='5' color=green> " + "Gelöst in " + tries + " Versuchen." + "</font> <font");
    }
    ...
    public static void enterPressed(){ //prüfen, ob das eingegeben Wort in der Liste vorkommt
        ...
        if (IsAValidWord(userInputLower, possibleWords)) {
            ...
            stats.setText("<html><font size='5'>Anderes Wort eingeben</font> <font");
        }
    }
    ...
    public static void buttonPressed(){
        ...
        int[] colorOfLetters = playWordle(userInputLower);
    ...
    public static int[] playWordle(String InputWordleWord) {
        ...
        //prüfen ob es 5 Buchstaben hat und in der Liste vorkommt
        if (!IsAValidWord(InputWordleWord, possibleWords)) {
            
        } else {
            for (int i = 0; i < 5; i++ ) { //das eingegeben Wort wird zum char[]-Array
                input[i] = InputWordleWord.charAt(i);
            }
        }
    ...
    public static void setNextLabel(String stringInColor){
        labels[tries - 1].setText(stringInColor.toUpperCase());
    }
